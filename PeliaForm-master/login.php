...
if(isset($_SESSION['peliaSafetyConnection']) && $_SESSION['peliaSafetyConnection'] == 'motDePass'){
            header('location: ../session-utilisateur/dashboard/profil.php') ;
		}
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="overlay2">
	...
	<div class="flex">
		<div class=" wrap-contact100">
			...
			<form class="contact100-form validate-form" action="verify.php" method="post" style="background:url('./images/patient.png');background-position:right;">
			<!-- <img src="images/doctor.png" alt=""> -->
			<a class="logo" href="index.php">Pélia</a>
			<h3 class="plate">Connexion à la plateforme Patient Pélia</h3>
						  ...
						  success : function(data){
							if(data.empty == "4"){							
							  ...
							  if (data.verified == "10"){
								...
								window.location.href = "../session-utilisateur/dashboard/profil.php"
							  }							  
