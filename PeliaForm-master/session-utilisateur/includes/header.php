		...
		<div class="nav-wraper">
			<div class="navbar">
				<ul class="navbar-nav">
					...
					<li class="nav-item">
						<a class="nav-link " href="../PhpSocket2/index.php"><img src="https://img.icons8.com/color/48/000000/filled-chat.png">Chat</a>	
					</li>
					<li class="nav-item">
						<a class="nav-link " href="../Video-Call-App-master/index.php"><img src="https://img.icons8.com/wired/64/000000/video-call.png">Video Chat</a>	
					</li>
